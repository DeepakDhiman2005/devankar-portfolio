        ...
        <main ref={containerRef} className="about-container">
            <section className="section1">
                ...
                <div className="about-intro overflow-hidden">
                    ...
                    <h3 className="dark:text-white">I{"\'"}m Devankar. Mern Stack Developer.</h3>
            ...
            <section className="section3">
                ...
                <div className="flex flex-col lg:flex-row justify-start lg:justify-between w-full items-start lg:items-center">
                    ...
                    <h3>Delhi, India | 05/2024 – 04/2025</h3>
                </div>

                <h2 className="font-semibold">Internship at OCPL Tech (3 months)</h2>
                <ul>
                ...
                <h2 className="font-semibold">Full-time Developer at Koncept Software Solutions (9 months)</h2>
                <ul>
